      ...
      <div class="modal-body">
        <form id="agregarProveedor" method="POST">
          ...
          <input type="hidden" name="_token" id="token" value="<?php echo csrf_token() ?>">
        	...
        	<h5>Nombre: </h5>
        	<input type="text" id="nombre" class="form-control w100" placeholder="Nombre del proveedor" required="true">

        	<h5>Dirección: </h5>
        	<input type="text" id="direccion" class="form-control w100" placeholder="Dirección" required="true">

        	<h5>Teléfono: </h5>
        	<input type="text" id="telefono" class="form-control w100" placeholder="Teléfono" required="true">

        	<h5>Correo: </h5>
        	<input type="email" id="correo" class="form-control w100" placeholder="Correo" required="true">
